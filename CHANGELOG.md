...
### Added
- Implemented *Cancel Free Fom Invite* method with documentation and example i [README](https://github.com/signnow/SignNowNodeSDK/blob/master/README.md#cancel-freeform-invite)
- Created [Applet](https://github.com/signnow/SignNowNodeSDK/blob/master/samples/applets/cancel-freeform-invite.js)
