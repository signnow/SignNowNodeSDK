...
class Template {
   ...
   * @typedef {Object} TemplateGetRoutingDetailsItem
   ...
   * @typedef {Object} TemplateGetRoutingDetailsCCStep
   ...
   * @property {TemplateGetRoutingDetailsItem[]} routing_details - array with routing details
   * @property {string[]} cc - CC emails
   * @property {TemplateGetRoutingDetailsCCStep[]} cc_step - array of CC`s steps
