...
class DocumentGroupTemplate {
   ...
   * @typedef {Object} DocumentGroupTemplateviewDocGrTplResponse
   ...
   * @param {function(err: ApiErrorResponse, res: DocumentGroupTemplateviewDocGrTplResponse)} [callback] - error first node.js callback
   */
