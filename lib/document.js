...
class Document {
   ...
   * @typedef {Object} DocumentViewFields
   * @property {string} id - id of specific document
   ...
   * @property {?string} origin_document_id - @todo
   * @property {string} owner - email of document owner
   * @property {boolean} template - is document a template or not
   * @property {Object} thumbnail - @todo
   * @property {Object[]} signatures - signature and initial elements
   * @property {Object[]} seals - []  @todo
   * @property {Object[]} texts - text and enumeration elements
   * @property {Object[]} checks - checkbox elements
   * @property {Object[]} inserts - [] @todo
   * @property {Object[]} tags - @todo
   * @property {Object[]} fields - all document fillable fields
   * @property {array} requests - [] @todo
   * @property {array} notary_invites - [] @todo
   * @property {Object[]} roles - document roles
   * @property {Object[]} field_invites - sent invites data
   * @property {number} version_time - @todo
   * @property {Object[]} enumeration_options - @todo
   * @property {array} attachments - [] @todo
   * @property {Object[]} routing_details - @todo
   * @property {array} integrations - [] @todo
   * @property {array} hyperlinks - [] @todo
   * @property {array} radiobuttons - [] @todo
   ...
   * @property {Object[]} originator_organization_settings - [] @todo
   * @property {Object[]} field_validators - validation rules for fields (date fields only?)
   * @property {Object} settings - {} @todo
   * @property {string} parent_id - id of document folder
   * @property {string} originator_logo - logo url
   * @property {Object[]} pages - list of document pages with page scr and page size.
   */
   ...
   * @param { function(err: ApiErrorResponse, res: DocumentViewFields) } [callback] - error first node.js callback
   */
