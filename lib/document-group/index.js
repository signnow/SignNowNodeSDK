...
class DocumentGroup {
   ...
   * @property {string} id - id of a Document Group
   * @property {string} token - your auth token
   * @property {?('zip'|'merged')} [type='zip'] - type of download flow, can be either `zip` or `merged`
   * @property {?('no'|'after_each_document'|'after_merged_pdf')} [with_history='no'] - type of history merging flow, can be `no`, `after_each_document`, or `after_merged_pdf`
   * @property {?string[]} [document_order=[]] - documents order for merging flow
   */
